// Portions of this file are based on DirectX Tool Kit SimpleMath.
//
// Copyright (c) Microsoft Corporation.
// Licensed under the MIT License.
//
// Modified and integrated into the ME::math namespace for MyEngineW.
// See LICENSES/DirectXTK-LICENSE.txt for the full license text.
